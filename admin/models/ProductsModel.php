...
trait ProductsModel
{
	...
	public function modelUpdate($id)
	{
		...
		if (!empty($_POST['title'])) {
			...
			$sql = 'update product set title="' . $title . '",price="' . $price . '",number="' . $number . '",thumbnail="' . $thumbnail . '",thumbnail_1="' . $thumbnail_1 . '",thumbnail_2="' . $thumbnail_2 . '",content="' . $content . '",id_category="' . $id_category . '",id_sanpham="' . $id_sanpham . '", updated_at="' . $updated_at . '" where id=' . $id;
	...
	public function modelCreate()
	{
		...
		if (!empty($_POST['title'])) {
			...
			$sql = 'insert into product(title, price, number, thumbnail, thumbnail_1, thumbnail_2,  content, id_category, id_sanpham, created_at, updated_at)
				values ("' . $title . '","' . $price . '","' . $number . '","' . $thumbnail . '","' . $thumbnail_1 . '","' . $thumbnail_2 . '","' . $content . '","' . $id_category . '","' . $id_sanpham . '","' . $created_at . '","' . $updated_at . '")';
			$query = $conn->prepare($sql);
			$query->execute();
		}
	}
