    ...
    <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light bg-white border-bottom border-bottom-lg-0 border-end-lg" id="navbarVertical">
        <div class="container-fluid">
            ...
            <a class="navbar-brand py-lg-2 mb-lg-5 px-lg-6 me-0" href="#">
                <h3 class="text-success"><img src="../assets/images/logo.jpg" width="40" ><span class="text-info">SHOP BEE</span>STORE</h3>
            </a>
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                            ...
                            <h1 class="h2 mb-0 ls-tight">
                                <img src="../assets/images/logo.jpg" width="60"> SHOP BEE Store</h1>
                        </div>
                        <!-- Actions -->
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow border-0 mb-7">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="index.php?controller=collections&action=create" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                    <span class=" pe-2">
                        ...
                        <table class="table table-hover table-nowrap">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">Thương Hiệu/Bộ Sưu Tập</th>
                                    <th></th>
                                    <th></th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                <tr>
                                    <?php
                                        ...
                                        <td>
                                        <a href="index.php?controller=collections&action=update&id=<?= $item->id ?>">
                                            <button class=" btn btn-warning">Sửa</button>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="index.php?controller=collections&action=delete&id=<?= $item->id ?>"  onclick="return window.confirm('Bạn có chắc chắn muốn xoá danh mục này không?');">
                        ...
                        <nav aria-label="Page navigation example">
                          ...
                          <?php
                            for ($i = 1; $i <= $numPage; $i++) {
                                ...
                                if ($i == $numPage) {
                                    echo '
                            <li class="page-item"><a class="page-link" href="index.php?controller=collections&page=' . $i . '">' . $i . '</a></li>';
                                } else {
                                    echo '
                            <li class="page-item"><a class="page-link" href="index.php?controller=collections&page=' . $i . '">' . $i . '</a></li>
                                    ';
