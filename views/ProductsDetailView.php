    ...
    <div class="container">
        ...
        <section class="main">
                    ...
                    <section class="main-order">
                        ...
                        <div class="box">
                            ...
                            <div class="about">
                                ...
                                <p class="price" style="padding-top:70px;margin-left:10px;">Giá: <span
                            ...
                            <div class="fb-comments" data-href="http://localhost/PROJECT/details.php" data-width="750"
                                data-numposts="5"></div>
                    </section>
                </div>
            </section>
            <section class="restaurants">
                <div class="title">
                    <h1>Các sản phẩm khác tại <span class="green" style="color: #0099FF;">Shop</span></h1>
                </div>
